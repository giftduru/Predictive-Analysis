...
Visualizing the correlation between the numerical features and sales price using a correlation plot, I observed a high correlation between the garage, fireplace, and basement with housing sale price. There are 10 variables with a correlation of at least 0.5 with saleprice.
